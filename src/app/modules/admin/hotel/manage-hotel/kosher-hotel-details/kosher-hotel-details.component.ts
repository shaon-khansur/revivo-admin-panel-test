...
@Component({
  selector: 'app-kosher-hotel-details',
  standalone: true,
  imports: [
    CommonModule,
    MatFormFieldModule,
  ...
  templateUrl: './kosher-hotel-details.component.html',
  styleUrls: ['./kosher-hotel-details.component.scss']
})
export class KosherHotelDetailsComponent {
  form: FormGroup;
  fileString: string;
  ...
  ngOnInit(): void {
      this.route.params.subscribe((params) => {
          ...
          if (id) {
              this.hotelService.getKosherHotelById(id).subscribe(
                  (hotel) => {
                      this.hotelIfo = hotel;
  ...
  update(): void {
      if (this.form.valid) {
          ...
          this.hotelService.updateKosherHotel(updatedHotel).subscribe(() => {
              this.router.navigate(['hotel/kosher-hotel-list']);
          });
      }
  }
