...
import { FlightsOrderDetailsComponent } from './modules/supports/flights-order-details/flights-order-details.component';
...
export const appRoutes: Route[] = [
    ...
    // Admin routes
    {
        ...
        children: [
            {
                path: 'dashboard',
                children: [{ path: 'admin', component: ExampleComponent }],
...

            {
                ...
                loadChildren: () =>
                    import('app/modules/admin/flights/flights.routes'),
            },
            {
                path: 'hotel',
                loadChildren: () =>
...

            {
                path: 'deals',
                loadChildren: () =>
                    import('app/modules/admin/deals/deals.routes'),
            },
            {
                path: 'deals/destinations',
                loadChildren: () =>
                    import(
                        'app/modules/admin/deals/destination/destination.routes'
                    ),
            },

            {
                ...
                children: [
                    ...
                    {
                        path: 'fare-upsell-api-error',
                        component: FareUpsellApiErroComponent,
                    },
                    {
                    ...
                    {
                        path: 'flights-order-details',
                        component: FlightsOrderDetailsComponent,
                    },
                ],
            },
            {
